...
export default values => {
  ...
  if (values.main && !values.main.sliderLeft) {
    errors.main.sliderLeft = 'Это поле обязательно для заполнения';
  }

  if (values.main && !values.main.sliderRight) {
    errors.main.sliderRight = 'Это поле обязательно для заполнения';
  }
